...
RippleDB is intended to support offline-first and multi-user applications. The system must remain correct when the network is unavailable and must converge deterministically across replicas.
