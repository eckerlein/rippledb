...
<Diagram
  ...
  nodes={[
    ...
    { id: 'tags-read', x: 300, y: 70, variant: 'label', label: 'converge_tags' },
    { id: 'todos', x: 300, y: 220, variant: 'label', label: 'todos' },
    { id: 'tags-write', x: 300, y: 290, variant: 'label', label: 'converge_tags' },
  ]}
  edges={[
    { from: 'append', to: 'load' },
    { from: 'load', to: 'lww' },
