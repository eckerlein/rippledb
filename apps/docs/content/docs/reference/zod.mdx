...
<InstallCommandTabs packages={["@rippledb/zod", "@rippledb/core", "zod"]} />
...
<Callout type="info">
  Both patterns provide full autocomplete for valid entity and field names. Use
  inline for simple cases, typed external when overrides need to be shared or
