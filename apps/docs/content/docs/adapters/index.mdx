...
Materialization is how _you, the app developer_, get a fast “current state” view of your data at all times.
...
<Callout type="info">
  These are the **supported pairings** we test and guarantee (especially around
  atomicity/transactions). Other combinations can be made to work, but you may
  need custom wiring to ensure the Db adapter and materializer share the same
...
<Callout type="warning">
  ...
  docs](/docs/adapters/db-drizzle#issync-flag) for details.
</Callout>
