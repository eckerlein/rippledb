...
<Callout type="info">
This package is used internally by `@rippledb/client-query` to provide a complete data fetching and caching solution. Consider using [client-query](/docs/reference/client-query) for a more integrated experience.
</Callout>

## Installation

<InstallCommandTabs packages={['@rippledb/bind-tanstack-query', '@tanstack/query-core']} />
