...
This store does **not** persist anything. For production apps, you'll want a persistent `store-*` implementation like [`store-sqlite`](/docs/adapters/store-sqlite) (or IndexedDB in the future).
</Callout>

## Installation

<InstallCommandTabs packages="@rippledb/store-memory" />
