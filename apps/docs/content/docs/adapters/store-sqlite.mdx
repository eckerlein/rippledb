...
<Callout type="info">
  This store requires a schema descriptor to create tables with proper columns,
  enabling SQL WHERE clauses on individual fields.
</Callout>

## Installation

<InstallCommandTabs packages={["@rippledb/store-sqlite", "better-sqlite3"]} />
