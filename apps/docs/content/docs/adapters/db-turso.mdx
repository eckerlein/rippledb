...
<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab value="pnpm">
```bash
pnpm add @converge/db-turso @libsql/client
```
  </Tab>
  <Tab value="npm">
```bash
npm install @converge/db-turso @libsql/client
```
  </Tab>
  <Tab value="yarn">
```bash
yarn add @converge/db-turso @libsql/client
```
  </Tab>
</Tabs>
...
Turso replicates your database to edge locations worldwide. Your Converge data benefits from:
