...
<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab value="pnpm">
```bash
pnpm add @converge/db-drizzle drizzle-orm
```
  </Tab>
  <Tab value="npm">
```bash
npm install @converge/db-drizzle drizzle-orm
```
  </Tab>
  <Tab value="yarn">
```bash
yarn add @converge/db-drizzle drizzle-orm
```
  </Tab>
</Tabs>
...
The `isSync` flag tells Converge whether the underlying Drizzle driver is synchronous or asynchronous:
...
Converge needs to know which style to use for proper transaction handling.
