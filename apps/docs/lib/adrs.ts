...
export const ADRS: AdrSummary[] = [
  ...
  },
  {
    ...
    description:
      "Solve N+1 by batching reads per tick rather than reactive joins.",
  ...
  },
  {
    ...
    description:
      "Core emits neutral DbEvents; UI integrations are opt-in adapters.",
  ...
  },
  {
    ...
    description:
      "CRDT semantics aren’t part of core; integrate separately if needed later.",
  ...
  },
  {
    ...
    description:
      "Prefer simple rerun-based correctness; defer optimizations until proven necessary.",
