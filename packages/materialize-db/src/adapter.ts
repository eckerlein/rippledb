 ...
 * ```
 */
export function createSqlExecutor<S extends RippleSchema = RippleSchema>(
...
export function createMaterializer<
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  D extends SchemaDescriptor<any>,
>(opts: CreateMaterializerOptions<D>): MaterializerAdapter<InferSchema<D>> {
