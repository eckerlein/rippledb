...
📚 **Documentation:** [rippledb.dev/docs/adapters/materialize-core](https://rippledb.dev/docs/adapters/materialize-core)
...
```typescript
import { applyChangeToState, materializeChange } from '@rippledb/materialize-core';
