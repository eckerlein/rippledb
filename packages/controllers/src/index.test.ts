...
import { createHlcState, tickHlc, makeUpsert } from '@rippledb/core';
...
describe('createEntityController', () => {
  ...
  it('uses provided ID from patch if present', async () => {
    ...
    const todo = await controller.create({ id: 'custom-id', title: 'Test', done: false });
  ...
  it('deletes an entity', async () => {
    ...
    const created = await controller.create({ title: 'To delete', done: false });
