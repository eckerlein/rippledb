...
import { defineSchema, type InferSchema, s } from "./schema";
...
describe("defineSchema", () => {
  ...
  it("infers enum types correctly", () => {
    ...
    expectTypeOf<MySchema["todos"]["status"]>().toEqualTypeOf<
      "pending" | "active" | "done"
    >();
  });
  ...
  it("infers optional fields correctly", () => {
    ...
    // Optional fields
    expectTypeOf<MySchema["todos"]["notes"]>().toEqualTypeOf<
      string | undefined
    >();
    expectTypeOf<MySchema["todos"]["priority"]>().toEqualTypeOf<
      number | undefined
    >();
  });
