...
export type DbEvent<
  S extends import("@rippledb/core").RippleSchema =
    import("@rippledb/core").RippleSchema,
  E extends import("@rippledb/core").EntityName<S> =
    import("@rippledb/core").EntityName<S>,
> = {
  entity: E;
  kind: DbEventKind;
  id?: string;
...
> {
   ...
   */
  getRow<E extends import("@rippledb/core").EntityName<S>>(
    entity: E,
    id: string,
  ): Promise<S[E] | null>;
  ...
  listRows(
    query: ListQuery,
  ): Promise<Array<S[import("@rippledb/core").EntityName<S>]>>;
